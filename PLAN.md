...
### Текущее продвижение (19.09.2026):
- Разработан и протестирован модуль `ijkbot_brain/mission_sm.py` (и псевдоним `mission_sm.python`):
  ...
  - Встроенный QR-декодер на базе OpenCV (`cv2.QRCodeDetector`) с возможностью прямого чтения с камеры и детерминированным регламентным fallback (+80 баллов).
...
- [x] Полный цикл миссии (от ввода текста до возврата на старт) выполняется по нажатию кнопки «СТАРТ» без ручного вмешательства.
